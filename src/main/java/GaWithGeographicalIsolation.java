...
public class GaWithGeographicalIsolation {
    ...
    int[] time;  // record every generation's min time, used to make line chart
    ...
    public void process(){
        ...
        while(generations++!=MAX_EVOLVE_TIME) {
            ...
            System.out.println(getMinTime(generations,1));
            System.out.println("2:");
            System.out.println(getMinTime(generations,2));
            System.out.println("3:");
            System.out.println(getMinTime(generations,3));
            select(1);
            select(2);
            select(3);
            cross(1);
